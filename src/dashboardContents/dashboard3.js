    ...
    <div>
      <GoogleMap
        ...
        {data.map((marker, index) => (
          <MarkerF key={index} position={{ lat: marker[0], lng: marker[1] }}
      ...
      <MapExplanation>
        <div style={{marginBottom: '10px', fontFamily: "Open Sans"}}>Explanation of the Map</div>
        <text style={{fontWeight: 'lighter'}}>This map shows your average stress level according to the location. The number and the color of the circle indicates your stress level in the location.</text>
      </MapExplanation>
    </div>
